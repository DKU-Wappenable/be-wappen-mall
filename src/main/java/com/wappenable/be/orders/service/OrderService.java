...
public class OrderService {
    ...
    // BANK로 주문 시 WAITING_FOR_DEPOSIT 상태에서 PAID 상태로 바꿈
    @Transactional
    ...
    // 장바구니 → 주문 (checkout)
    @Transactional
    public void checkout(Long userId, String deliveryAddress, String deliveryRequest) {
        // 1. User 조회
